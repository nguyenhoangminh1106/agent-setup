...
The script installs these skills: `commit-push`, `name-branch`, `worktree-create`, `worktree-remove`, `branch-risk-review`, `clean-ai-comments`, `pr-description`, `pr-triage`, `clarify`, `spec`, `fix-review`, `ticket`, `daily-update`, `feature-summary`, `testing-instructions`, `db-unsync-fix`, `query-db`.
