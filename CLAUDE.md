...
The script installs these skills: `commit-push`, `pr-triage`, `branch-risk-review`, `worktree-create`, `worktree-remove`, `clean-ai-comments`, `ticket`, `spec`, `feature-summary`, `testing-instructions`, `query-db`.
